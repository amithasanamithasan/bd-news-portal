...
import image2 from '@/assets/Capture5.PNG'
import image3 from '@/assets/Capture2.PNG'
import image4 from '@/assets/Capture3.PNG'
import image5 from '@/assets/Capture4.PNG'
...
const LatestNews = () => {
    ...
    return (
        ...
        <Box className="my-5 ">
            ...
            <Card className={`${theme ? "bg-white text-black" : "bg-[#677ea1]"}`}>
                <CardActionArea>
                    <CardMedia>
            ...
            <Grid className="mt-3" container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Grid item xs={6}>
                    <Card className={`${theme ? "bg-white text-black" : "bg-[#677ea1]"}`}>
                        <CardActionArea>
                            <CardMedia>
                                <Image src={image3} width={800} alt='top news' ></Image>
                            </CardMedia>
                ...
                <Grid item xs={6} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                    <Card className={`${theme ? "bg-white text-black" : "bg-[#677ea1]"}`}>
                        <CardActionArea>
                            <CardMedia>
                                <Image src={image2} width={800} alt='top news' ></Image>
                            </CardMedia>
                ...
                <Grid item xs={6} >
                    <Card className={`${theme ? "bg-white text-black" : "bg-[#677ea1]"}`}>
                        <CardActionArea>
                            <CardMedia>
                                <Image src={image4} width={800} alt='top news' ></Image>
                            </CardMedia>
                ...
                <Grid item xs={6} >
                    <Card className={`${theme ? "bg-white text-black" : "bg-[#677ea1]"}`}>
                        <CardActionArea>
                            <CardMedia>
                                <Image src={image5} width={800} alt='top news' ></Image>
                            </CardMedia>
